...
<?php
    ...
    if (isset($_GET['edit']))
    {
        ...
        <h2>   </h2>
        <form action="electricity.php" metho="get">
            <label style="color: white;"><h3>unit price</h3></label>
            <input type ="text" size="45" style="height: 49px; width: 238px;" placeholder="Enter new unit price of electricity" name="unit_price"> <br>
            <br>
            <br>
            <br>
            ...
            <button type = "submit" value="cancel" name="cancel" style="color:black;">cancel</button>
